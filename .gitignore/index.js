...
client.login(NzU5NzU5MzI0ODU0ODc4MjIz.X3CLAg.PXcKJGFWECk-GtRYP4MgHa_t3Rc)
...
client.on("message", message => {
    ...
    if(message.content.startsWith("!report")) {
        ...
        client.channels.get("759536540698542142").send("<@&759536540698542142> report de: <@" + message.author.id + "> vous a été envoyé, raison: " + raisondureport);
    }
})
